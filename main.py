...
with open('recipes.txt', encoding='utf-8') as recipe_text:
    ...
    for line in recipe_text:
        ...
        # тоже значение что и dish_name, а она принимает следуюшую строку с количеством ингридиентов.
        ing_list = []
        ing_dic = {}
...
# распространяться только на его часть? В решении реализовано, что количество персон распространяется на весь заказ.
